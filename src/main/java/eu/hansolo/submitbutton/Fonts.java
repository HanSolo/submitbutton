...
public class Fonts {
    ...
    static {
        try {
            robotoThinName             = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/submitbutton/Roboto-Thin.ttf"), 10).getName();
            robotoLightName            = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/submitbutton/Roboto-Light.ttf"), 10).getName();
            robotoRegularName          = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/submitbutton/Roboto-Regular.ttf"), 10).getName();
            robotoMediumName           = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/submitbutton/Roboto-Medium.ttf"), 10).getName();
            robotoBoldName             = Font.loadFont(Fonts.class.getResourceAsStream("/eu/hansolo/fx/submitbutton/Roboto-Bold.ttf"), 10).getName();
